...
namespace Nextlabs.Tools
{
    public static class TokenHelper
    {
            ...
            string spoClientSecret)
        {
            ...
            string clientId = GetFormattedPrincipal(spoClientId, HostedAppHostName, targetRealm);



            OAuth2AccessTokenRequest oauth2Request = OAuth2MessageFactory.CreateAccessTokenRequestWithClientCredentials(clientId, spoClientSecret, resource);
